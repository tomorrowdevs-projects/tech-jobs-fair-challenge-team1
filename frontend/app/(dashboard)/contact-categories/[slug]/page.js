...
const ContactCategoriesEditPage = ({ params }) => {
            ...
            <Row>
                <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10, offset: 1 }} md={12} xs={12}>
                    ...
                    <div className="py-6">
                        ...
                        <Card className="mt-6">
                            <Card.Body>
                                <Card.Title as="h4">Delete contact category</Card.Title>            
                                <div>
                                <p>Are you sure to delete this contact category?</p>
                                <Button variant="danger" onClick={() => setShowDeleteModal(true)}>Delete contact category</Button>
                                </div>
                            </Card.Body>
                        </Card>
                        ...
                        <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
                            ...
                            <Modal.Body>You are deleting this contact category. This action is irreversible. Are you sure to proceed?</Modal.Body>
                            <Modal.Footer>
...
export default ContactCategoriesEditPage